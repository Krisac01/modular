...
export function FacialRecognitionScanner() {
  ...
  const startCamera = async () => {
    if (!facialRecognitionEnabled) {
      toast.error("El reconocimiento facial está desactivado. Active la función desde el menú principal.");
      return;
    }
  ...
  // Show disabled state if facial recognition is not enabled
  if (!facialRecognitionEnabled) {
    return (
        ...
        <CardContent className="pt-6 text-center">
          <div className="p-4">
            ...
            <p className="text-red-600 mb-4">
              Esta funcionalidad está desactivada. Para usar el reconocimiento facial, 
              active la función desde el menú principal.
            </p>
            <Button 
