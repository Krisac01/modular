/*
  ...
  1. New Structure
    - Ensures user_profiles table has the correct structure to match the application code
    - Fixes column naming issues (using full_name instead of name)
  ...
  3. Data
    - Adds initial demo users
    - Adds initial cacao sections and greenhouse rows
*/
...
-- Drop and recreate user_profiles table to ensure correct structure
