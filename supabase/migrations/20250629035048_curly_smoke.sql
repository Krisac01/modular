...
-- Create user profiles table first - FIXED: using uuid type for id
...
-- Create facial recognition sessions table - FIXED: ensuring user_id is uuid type to match user_profiles.id
...
-- Create location records table - FIXED: ensuring user_id is uuid type to match user_profiles.id
...
-- Create supply records table - FIXED: ensuring assigned_to is uuid type to match user_profiles.id
...
-- Create tool records table - FIXED: ensuring assigned_to is uuid type to match user_profiles.id
...
(gen_random_uuid(), 'roberto.sanchez@agro.com', 'Roberto Sánchez', 'Técnico de Campo', 'Campo')
